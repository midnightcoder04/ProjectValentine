...
function Home() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-pink-100 text-center p-6">
      <h1 className="text-4xl font-bold text-red-500">Scratch & Match: Valentine’s Edition 💖</h1>
      <p className="text-lg text-gray-700 mt-4 max-w-lg">
        Take a fun personality test, scratch to reveal your Valentine personality, and check your match compatibility!
      </p>
      <Link to="/quiz">
